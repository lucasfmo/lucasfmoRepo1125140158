---
title: "Töltse le a szoftverfrissítéseket - Configuration Manager |} Microsoft Docs"
description: "A szoftverfrissítések letöltése varázsló segítségével töltse le a szoftverfrissítéseket, és ossza ki őket a terjesztési pontok, a telepítést az ügyfeleknél készen állnak."
keywords: 
author: dougeby
ms.author: dougeby
manager: angrobe
...
# <a name="download-software-updates"></a>Szoftverfrissítések letöltése  

*Vonatkozik: A System Center Configuration Manager (aktuális ág)*

Többféleképpen elérhetők a szoftverfrissítéseknek a Configuration Manager alkalmazásban. Amikor egy automatikus központi telepítési szabály (ADR) létrehozása, vagy a szoftverfrissítések manuális központi telepítése, a szoftverfrissítések letöltődnek a helykiszolgálón lévő tartalomtárba. Ezt követően a tartalomtár a konfigurált központi telepítési csomaggal társított terjesztési pontokon a szoftverfrissítések lesz másolva. Ha a központi telepítés előtt le szeretné tölteni a szoftverfrissítéseket, ehhez a Szoftverfrissítések letöltése varázslót használhatja. Ezzel gondoskodhat arról, hogy a szoftverfrissítések elérhetők legyenek a terjesztési pontokon, mielőtt megkezdődik az ügyfélszámítógépekre való központi telepítésük.  

> [!NOTE]  
>  További információ a tartalomállapot figyeléséről: [Tartalomállapot figyelése](../deploy-use/monitor-software-updates.md#BKMK_ContentStatus).  

A Szoftverfrissítések letöltése varázsló használatával a következő eljárást követve töltheti le a szoftverfrissítéseket.  

#### <a name="to-download-software-updates"></a>Szoftverfrissítések letöltése  
