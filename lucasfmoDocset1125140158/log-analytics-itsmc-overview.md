...
ms.author: v-jysur
---
# <a name="centrally-manage-itsm-work-items-using-it-service-management-connector-preview"></a>Centrally manage ITSM work items using IT Service Management Connector (Preview)
...
## <a name="configuring-the-itsmc-connection-with-your-itsm-productsservices"></a>Configuring the ITSMC connection with your ITSM products/services
...
## <a name="itsmc-integration-with-other-oms-solutions"></a>ITSMC integration with other OMS solutions
...
## <a name="create-itsm-work-items-for-oms-alerts"></a>Create ITSM work items for OMS alerts
...
## <a name="create-itsm-work-items-from-oms-logs"></a>Create ITSM work items from OMS logs
